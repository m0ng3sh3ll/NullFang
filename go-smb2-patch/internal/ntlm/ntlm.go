...
// Build 19041 = Windows 10 20H1. Sending build 0 is a scanner fingerprint.
// Bytes 2-3 are ProductBuild as uint16 LE: 19041 = 0x4A41.
var version = []byte{
	0: WINDOWS_MAJOR_VERSION_10,
	1: WINDOWS_MINOR_VERSION_0,
	2: 0x41, // ProductBuild low byte
	3: 0x4A, // ProductBuild high byte (0x4A41 = 19041)
